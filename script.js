...
function toggleLanguage() {
  ...
  typeWriter(newText, textElement);
  isItalian = !isItalian;
}
...
function typeWriter(text, element, i = 0) {
  if (i < text.length) {
    ...
    setTimeout(() => typeWriter(text, element, i + 1), 15); // velocità caratteri
  }
}

// Mostra subito il testo in italiano al primo caricamento
document.addEventListener("DOMContentLoaded", () => {
  typeWriter(italianText, document.getElementById("bio-text"));
});
